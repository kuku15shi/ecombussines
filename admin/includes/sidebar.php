...
<nav class="sidebar" id="sidebar">
  <div class="sidebar-brand">
    <div style="display:flex; justify-content:space-between; align-items:center; width:100%;">
      ...
      <button onclick="closeSidebar()" class="btn-icon d-lg-none"
        style="background:none; border:none; color:var(--text-muted); font-size:1.5rem; padding:0;" id="mobileCloseBtn">
  ...
  <div class="sidebar-profile"
    style="padding: 1rem 1.5rem; border-bottom: 1px solid var(--border); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 1rem;">
    <div class="admin-avatar"
      style="width: 45px; height: 45px; transform: scale(1); box-shadow: 0 5px 15px rgba(108, 99, 255, 0.3);">
      <?= strtoupper(substr($_SESSION['admin_name'] ?? 'A', 0, 1)) ?></div>
    <div>
  ...
  <div class="sidebar-menu">
    ...
    <a href="products.php"
      class="menu-item <?= ($currentPage === 'products' || ($currentPage === 'products' && isset($_GET['action']))) ? 'active' : '' ?>">
    ...
    <a href="brands.php" class="menu-item <?= $currentPage === 'brands' ? 'active' : '' ?>">
      <div class="menu-icon"><i class="bi bi-tag"></i></div> Brands
    </a>
    ...
    <a href="delivery_addresses.php" class="menu-item <?= $currentPage === 'delivery_addresses' ? 'active' : '' ?>">
      <div class="menu-icon"><i class="bi bi-geo-alt"></i></div> Delivery Addresses
    </a>

    <div class="menu-section-label">Search Engine</div>
    <a href="synonyms.php" class="menu-item <?= $currentPage === 'synonyms' ? 'active' : '' ?>">
      <div class="menu-icon"><i class="bi bi-fonts"></i></div> Synonyms
    </a>
    <a href="search_logs.php" class="menu-item <?= $currentPage === 'search_logs' ? 'active' : '' ?>">
      <div class="menu-icon"><i class="bi bi-search"></i></div> Search Logs
    </a>

    <div class="menu-section-label">Video Commerce</div>
    <a href="videos.php" class="menu-item <?= $currentPage === 'videos' ? 'active' : '' ?>">
      <div class="menu-icon"><i class="bi bi-play-btn"></i></div> Shoppable Videos
    </a>
    <a href="live_streams.php" class="menu-item <?= $currentPage === 'live_streams' ? 'active' : '' ?>">
      <div class="menu-icon"><i class="bi bi-broadcast"></i></div> Live Streams
    </a>
    ...
    <a href="wa_messages.php"
      class="menu-item <?= ($currentPage === 'wa_messages' && !isset($_GET['tab'])) ? 'active' : '' ?>">
      <div class="menu-icon"><i class="bi bi-robot"></i></div> Bot Settings
    </a>
    <a href="wa_messages.php?tab=chat"
      class="menu-item <?= ($currentPage === 'wa_messages' && ($_GET['tab'] ?? '') === 'chat') ? 'active' : '' ?>">
      <div class="menu-icon"><i class="bi bi-chat-dots"></i></div> Customer Chats
    </a>
    <a href="wa_messages.php?tab=broadcast"
      class="menu-item <?= ($currentPage === 'wa_messages' && ($_GET['tab'] ?? '') === 'broadcast') ? 'active' : '' ?>">
    ...
    <a href="logout.php" class="menu-item" style="margin-top: 1rem;">
      <div class="menu-icon" style="background:rgba(255,101,132,0.15);"><i class="bi bi-box-arrow-right"
