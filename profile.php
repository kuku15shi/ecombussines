...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($oldPw && $newPw) {
        if (password_verify($oldPw, $currentUser['password'])) {
            ...
            } else { $error = 'New password must be at least 8 characters.'; }
...
<div class="page-wrapper">
  <div class="container-sm">
    <h1 style="font-size:2rem; font-weight:800; margin-bottom:2rem;"><i class="bi bi-person-circle" style="color:var(--primary);"></i> My Profile</h1>
    ...
    <div class="profile-layout-grid">
      ...
      <div>
        <div class="glass-card" style="padding:2rem; text-align:center;">
          <div style="width:80px; height:80px; border-radius:50%; background:linear-gradient(135deg,var(--primary),var(--accent2)); display:flex; align-items:center; justify-content:center; font-size:2rem; font-weight:800; margin:0 auto 1rem;">
          ...
          <div class="grid-2" style="gap:0.75rem; margin-top:1.5rem;">
            ...
            <a href="wishlist" style="background:var(--glass); border:1px solid var(--glass-border); border-radius:var(--radius-sm); padding:0.875rem; text-decoration:none; text-align:center; transition:var(--transition);">
        ...
        <div class="glass-card" style="padding:2rem;">
          ...
          <form method="POST">
            ...
            <div class="grid-2">
              ...
              <div class="form-group" style="margin-bottom:0;"><label class="form-label">State</label><input type="text" name="state" class="form-control" value="<?= htmlspecialchars($currentUser['state'] ?? '') ?>"></div>
              <div class="form-group" style="margin-bottom:0;"><label class="form-label">Pincode</label><input type="text" name="pincode" class="form-control" value="<?= htmlspecialchars($currentUser['pincode'] ?? '') ?>"></div>
            ...
            <button type="submit" class="btn-primary-luxury" style="margin-top:1.5rem;"><i class="bi bi-save"></i> Save Changes</button>
          </form>
        </div>
      </div>
    </div>
