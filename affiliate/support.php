...
<body>
    ...
    <div class="main-content">
        <header class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h1 style="font-weight: 800; font-size: 2.25rem; letter-spacing: -1px; color: #1e293b;">Support Center
                </h1>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="glass-card mb-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <div class="icon-box mb-0"
                            style="background: rgba(99, 102, 241, 0.1); color: #6366f1; width: 42px; height: 42px; font-size: 1.25rem;">
                    ...
                    <div class="accordion accordion-flush" id="faqAffiliate">
                        <div class="accordion-item bg-transparent border-bottom">
                            <h2 class="accordion-header">
                                <button
                                    class="accordion-button collapsed bg-transparent fw-700 px-0 py-3 text-main shadow-none"
                            ...
                            <div id="q1" class="accordion-collapse collapse" data-bs-parent="#faqAffiliate">
                                <div class="accordion-body px-0 text-secondary fw-500 small">
                                    Commissions are verified after the order return period (usually 7-14 days). Once
                                    verified, you can request a withdrawal if your balance meets the minimum threshold
                                    of <?= formatPrice(AFFILIATE_MIN_WITHDRAWAL) ?>.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item bg-transparent border-bottom">
                            ...
                            <div id="q2" class="accordion-collapse collapse" data-bs-parent="#faqAffiliate">
                                <div class="accordion-body px-0 text-secondary fw-500 small">
                                    We use a secure cookie-based tracking system. When a user clicks your link, a cookie
                                    is stored for 30 days. Any purchase they making during that time will be credited to
                                    your account.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item bg-transparent">
                            ...
                            <div id="q3" class="accordion-collapse collapse" data-bs-parent="#faqAffiliate">
                                <div class="accordion-body px-0 text-secondary fw-500 small">
                                    No, self-referrals are strictly prohibited. Our system automatically filters those
                                    out and repeated attempts can lead to account suspension.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="glass-card">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div
                                class="p-4 border rounded-4 d-flex align-items-center gap-3 bg-light bg-opacity-50 transition-all hover-shadow">
            ...
            <div class="col-lg-4">
                <div class="glass-card text-center py-5 shadow-lg border-0"
                    ...
                    <div class="icon-box mx-auto mb-4 shadow-lg"
                        style="background: rgba(255, 255, 255, 0.2); color: white; width: 80px; height: 80px; font-size: 2.5rem;">
                        <i class="bi bi-headset"></i>
                    </div>
                    <h4 class="fw-800 mb-2">Partner Manager</h4>
                    <p class="small text-white-50 mb-4 px-4 fw-500">Dedicated support for our verified partners. We
                        prioritize your success.</p>
                    <a href="mailto:support@MIZ MAX.com"
                        class="btn btn-light rounded-pill px-5 py-3 fw-800 text-primary shadow-lg transition-transform"
