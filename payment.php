...
<head>
    ...
    <style>
        ...
        .order-label { font-size: 0.8rem; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 1px; }
        .order-val { font-weight: 800; font-size: 1.1rem; color: #fff; }
...
<body>
    ...
    <div class="payment-container">
        <div class="payment-card">
            ...
            <p style="margin-top: 25px; font-size: 0.75rem; color: var(--text-muted); display: flex; align-items: center; justify-content: center; gap: 6px;">
