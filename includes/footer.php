...
<footer class="footer">
  <div class="container">
    ...
    <div class="footer-grid">
      <div>
        <div class="footer-brand">✦ MIZ MAX</div>
        <p class="footer-text">Your premium destination for luxury shopping. Curated collections, unbeatable prices, and
          an experience beyond ordinary.</p>
      ...
      <div>
        ...
        <ul class="footer-links">
          <?php foreach (array_slice($categories, 0, 5) as $cat): ?>
            <li><a href="<?= SITE_URL ?>/category/<?= $cat['slug'] ?>"><i class="bi bi-chevron-right"></i>
      ...
      <div>
        ...
        <ul class="footer-links">
          <li><a href="mailto:support@MIZ MAX.com"><i class="bi bi-envelope"></i> support@MIZ MAX.com</a></li>
          <li><a href="tel:+916282626989"><i class="bi bi-telephone"></i>+91 6282 626 989</a></li>
    ...
    <div class="footer-bottom">
      <div class="footer-bottom-grid">
        <div class="footer-copyright">
          <p class="copyright-text">© <?= date('Y') ?> MIZ MAX. All rights reserved.</p>
...
<a href="https://wa.me/916282626989" class="fab-whatsapp" target="_blank">
