...
<head>
  ...
  <title>Login / Register – MIZ MAX</title>
...
<body>
  <div class="auth-container">
    ...
    <div style="text-align:center; margin-bottom:2rem;">
      <a href="index.php"
        style="font-size:2rem; font-weight:900; background:linear-gradient(135deg,var(--primary),var(--accent2)); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; text-decoration:none;">✦
        MIZ MAX</a>
    ...
    <div class="glass-card auth-card">
      ...
      <div class="tab-switcher">
        ...
        <button class="tab-btn <?= $tab === 'register' ? 'active' : '' ?>" onclick="switchAuthTab('register')">Create
          Account</button>
      </div>
        ...
        <form method="POST">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="password" name="password" class="form-control" id="loginPw" placeholder="Enter password"
                required>
              <button type="button" class="toggle-pw" onclick="togglePw('loginPw',this)"><i
                  class="bi bi-eye"></i></button>
            </div>
          </div>
          <button type="submit" name="login" class="btn-primary-luxury"
            style="width:100%; justify-content:center; padding:1rem; font-size:1.05rem; margin-top:0.5rem; border-radius: 12px;">
      ...
      <div id="registerForm" style="display:<?= $tab === 'register' ? 'block' : 'none' ?>">
        <form method="POST">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <i class="bi bi-lock input-icon"></i>
              <input type="password" name="password" class="form-control" id="regPw" placeholder="Min. 8 characters"
                required>
              <button type="button" class="toggle-pw" onclick="togglePw('regPw',this)"><i
                  class="bi bi-eye"></i></button>
            </div>
          </div>
          <div class="form-group">
          ...
          <button type="submit" name="register" class="btn-primary-luxury"
            style="width:100%; justify-content:center; padding:1rem; font-size:1.05rem; margin-top:0.5rem; border-radius: 12px;">
      ...
      <button onclick="simulateGoogleLogin(event)" class="google-btn-mock"
        style="width:100%; justify-content:center; padding:1rem; font-size:1rem; margin-top:0.5rem; background:#fff !important; color:#333 !important; border:1px solid #e0e0e0 !important; border-radius:12px; font-weight:700; display:flex; align-items:center;">
    ...
    <p style="text-align:center; margin-top:1.25rem;">
      <a href="<?= SITE_URL ?>/index" style="color:var(--text-muted); font-size:0.85rem; text-decoration:none;"><i
